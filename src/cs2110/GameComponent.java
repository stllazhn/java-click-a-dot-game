...
public class GameComponent extends JPanel implements MouseListener {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        // [1]:
        // https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/event
        // /MouseEvent.html
    ...
    private static class Target {
        ...
        void paintDot(Graphics g) {
            ...
            // [1]:
            // https://docs.oracle.com/en/java/javase/17/docs/api/java.desktop/java/awt/Graphics.
            // html
            // [2]:
