...
public class GameMain {
    ...
    private static JComponent makeSliderPanel(JSlider slider, String title) {
        ...
        newPanel.setBorder(BorderFactory.createEmptyBorder(4,4,4,4));
        ...
        return newPanel;  // Replace this line with one that returns your panel
    }
    ...
    private static void saveScore(JFrame frame, int score) {
        ...
        try (PrintWriter out =
            ...
            optPane.showMessageDialog(frame,e.getClass().getName()+": "
                    +e.getMessage(),e.getClass().getName(),optPane.ERROR_MESSAGE);
        }
    }
}
